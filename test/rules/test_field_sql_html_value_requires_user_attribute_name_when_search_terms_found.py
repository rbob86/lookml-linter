...
def test_run_method_successfully_validates_field_with_search_term_hits_and_user_atrributes_permissions() -> None:
...
def test_run_method_fails_field_with_search_term_hits_and_no_user_atrributes_permissions() -> None:
    rule = FieldSqlHtmlValueRequiresUserAttributeNameWhenSearchTermsFound()
